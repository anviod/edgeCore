...
|---|---|
| 日期 | 2026-07-28 |
| EdgeX 版本 | v2.7 (Phase 3 EdgeX 侧全部实现) |
| EdgeOS 版本 | v2.7 (Phase 1/2 完成 + 启动韧性) |
| 共识文档 | V1-to-EAN-Migration-Assessment.md v2.7 |
| 验证环境 | 本地 Windows, EdgeX :8080, EdgeOS :8000, MQTT broker :18083 |
...
| 验证项 | 结果 | 说明 |
|---|---|---|
| EdgeX MCP Runtime 状态 | **通过** | 63 Cap, status=online, version=2.0.0 |
...
| 任务 | 状态 | 说明 |
|---|---|---|
| OS-P3-01 | 未做 | 移除 V1 Fallback + V1 合成 Cap purge |
| OS-P3-02 | 部分 | 前端写操作切 EAN Invoke（ControlView） |
| OS-P3-03 | 未做 | EAN Invoke 监控面板 |
| OS-13 | 未做 | Invoke status 进度订阅 |
| Agent version | 过渡期 | V1 Bridge 先注册导致 version=1.0.0；OS-P3-01 完成后解决 |
